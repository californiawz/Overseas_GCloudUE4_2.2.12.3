...
#ifndef GCloud_INetwork_h
#define GCloud_INetwork_h
...
namespace GCloud
{
    ...
    typedef struct EXPORT_CLASS _tagADetailNetworkInfo : public GCloud::ApolloBufferBase{
        ADetailNetworkState state;
        GCarrier carrier;
        GCloud::AString carrierCode;
        GCloud::AString ssid;
        GCloud::AString bssid;
        GCloud::AString currentAPN;
    ...
    bool ParseURI(const char* url, GCloud::AString& scheme, GCloud::AString& host, unsigned short& pPort);
    bool ConvertIpV4To6(const char* ipv4, GCloud::AString& ipv6);
}
