...
namespace GCloud
{
    namespace GVoice
    {
        ...
        public:
             ...
             * @see ErrorNo
             */
            virtual ErrorNo SpeechToText(const char *fileID, int msTimeout = 60000,  Language language = kLanguageCN) = 0;
        ...
        public:
             ...
             * @see ErrorNo
             */
            virtual ErrorNo SpeechToText(const char *fileID, const char *token, int timestamp, int msTimeout = 60000,  Language language = kLanguageCN) = 0;
		...
		/**
		 * Get the voice engine instance for wwise 
		 *
		 * @return : the voice instance on success, or NULL on failed.
		 */
		 extern "C" GCLOUD_VOICE_API IGCloudVoiceEngine *GetVoiceEngineWwise(); 
